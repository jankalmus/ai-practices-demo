 ...
 * @description Spending-by-category bar chart for the monthly overview. Each row links to the category detail page.
            ...
            <li key={row.category}>
              ...
              >
                <div className="flex items-baseline justify-between gap-2 text-sm">
                  <span className="flex items-center gap-2 group-hover/row:text-zinc-900 dark:group-hover/row:text-zinc-100">
